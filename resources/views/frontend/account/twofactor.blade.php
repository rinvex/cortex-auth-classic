                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="text-center">
                                                <a class="btn btn-default text-center" role="button" data-toggle="collapse" href="#collapse2Example" aria-expanded="false" aria-controls="collapseSecretKey">
                                                    {{ trans('twofactor.totp_backup_button', ['count' => count(array_get($settings, 'totp.backup'))]) }}
                                                </a>
                                            </div>
                                            ...
                                            <div class="collapse" id="collapse2Example">
                                                ...
                                                @if(array_get($settings, 'totp.backup'))
                                                    <div class="panel panel-primary">
                                                        <header class="panel-heading">
                                                            <a class="btn btn-default btn-xs pull-right" style="margin-left: 10px" href="{{ route('frontend.account.twofactor.totp.backup') }}">{{ trans('twofactor.totp_backup_generate') }}</a>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div>
                                                                ...
                                                                {!! trans('twofactor.totp_backup_notice', ['backup_at' => array_get($settings, 'totp.backup_at')]) !!}
