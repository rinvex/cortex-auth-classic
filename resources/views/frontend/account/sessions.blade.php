            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <section class="panel panel-default">
                    ...
                    <header class="panel-heading">
                        {{ trans('cortex/fort::common.active_sessions') }}
                    </header>
                    ...
                    <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-{{ $persistence->token }}" aria-expanded="false" aria-controls="collapse-{{ $persistence->token }}">
                                                        ...
                                                        <div class="col-md-11 col-sm-11 col-xs-11">
                                                            ...
                                                            @if ($persistence->token === request()->session()->getId())<span class="label label-success">{{ trans('cortex/fort::common.you') }}</span>@endif
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-confirmation" data-item-href="{{ route('frontend.account.sessions.flush') }}" data-item-type="all"><i class="fa fa-remove"></i> {{ trans('cortex/fort::messages.sessions.flush_all_heading') }}</button>
