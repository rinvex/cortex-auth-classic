                        ...
                        {{ Form::model($currentUser, ['route' => 'frontend.account.settings.update', 'class' => 'form-horizontal']) }}
                            ...
                            <div class="row">
                                <div class="form-group{{ $errors->has('country_code') ? ' has-error' : '' }}">
                                    {{ Form::label('country_code', trans('cortex/fort::common.country'), ['class' => 'col-md-3 control-label']) }}
                            ...
                            <div class="row">
                                <div class="form-group{{ $errors->has('language_code') ? ' has-error' : '' }}">
                                    {{ Form::label('language_code', trans('cortex/fort::common.language'), ['class' => 'col-md-3 control-label']) }}
