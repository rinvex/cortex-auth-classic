...
{{-- Scripts --}}
@push('scripts')
    {!! JsValidator::formRequest(Cortex\Fort\Http\Requests\Guestarea\RegistrationProcessRequest::class)->selector('#guestarea-auth-register-process') !!}
...
@section('content')
    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            {{ Form::open(['url' => route('guestarea.auth.register.process'), 'id' => 'guestarea-auth-register-process']) }}
                ...
                <div class="row">
                    <div class="col-xs-8">
                        {{ Html::link(route('guestarea.auth.login'), trans('cortex/fort::common.registered_already')) }}
