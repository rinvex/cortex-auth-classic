...
{{-- Scripts --}}
@push('scripts')
    {!! JsValidator::formRequest(Cortex\Fort\Http\Requests\Guestarea\EmailVerificationProcessRequest::class)->selector('#guestarea-verification-email-send') !!}
@endpush
...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {{ Form::open(['url' => route('guestarea.verification.email.send'), 'id' => 'guestarea-verification-email-send']) }}
