...
{{-- Scripts --}}
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Frontarea\PasswordResetPostProcessRequest::class)->selector('#frontarea-passwordreset-form')->ignore('.skip-validation') !!}
@endpush
    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                {{ Form::open(['url' => route('frontarea.cortex.auth.account.passwordreset.process'), 'id' => 'frontarea-passwordreset-form', 'class' => 'space-y-6']) }}
