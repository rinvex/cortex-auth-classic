...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Frontarea\AccountTwoFactorTotpProcessRequest::class)->selector('#frontarea-twofactor-totp-form')->ignore('.skip-validation') !!}
@endpush
