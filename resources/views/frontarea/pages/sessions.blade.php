            ...
            <div class="col-md-3">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-usermenu">
                        <ul class="nav">
                            <li>
                                <a href="{{ route('frontarea.account.settings') }}#settings-tab" aria-controls="settings-tab" role="tab" data-toggle="tab">
                                    <i class="fa fa-cogs"></i>{{ trans('cortex/fort::common.settings') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('frontarea.account.settings') }}#attributes-tab" aria-controls="attributes-tab" role="tab" data-toggle="tab">
                                    <i class="fa fa-leaf"></i>{{ trans('cortex/fort::common.attributes') }}
                                </a>
                            </li>
                            <li class="active">
                                <a href="{{ route('frontarea.account.sessions') }}">
                                    <i class="fa fa-list-alt"></i>{{ trans('cortex/fort::common.sessions') }}
                                </a>
                            </li>
                                                ...
                                                <div class="panel-heading" role="tab" id="heading-{{ $session->id }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
                                                            <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-confirmation" data-modal-action="{{ route('frontarea.account.sessions.flush', ['id' => $session->id]) }}" data-modal-title="{!! trans('cortex/foundation::messages.delete_confirmation_title') !!}" data-modal-body="{!! trans('cortex/foundation::messages.delete_confirmation_body', ['type' => 'session', 'name' => $session->id]) !!}" title="{{ trans('cortex/foundation::common.delete') }}"><i class="fa fa-remove"></i></a>
                                                        </div>
