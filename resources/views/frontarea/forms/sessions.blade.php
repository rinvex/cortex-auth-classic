                ...
                <div class="profile-content">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="sessions">
                            ...
                            @include('cortex/fort::frontarea.partials.confirm-deletion')
                                                ...
                                                <div class="panel-heading" role="tab" id="heading-{{ $session->id }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1 col-sm-1 col-xs-1">
                                                            <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-confirmation" data-item-href="{{ route('frontarea.account.sessions.flush', ['id' => $session->id]) }}" data-item-type="single"><i class="fa fa-remove"></i></a>
                                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-confirmation" data-item-href="{{ route('frontarea.account.sessions.flush') }}" data-item-type="all">
