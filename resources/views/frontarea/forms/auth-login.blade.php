{{-- Master Layout --}}
@extends('cortex/foundation::frontarea.layouts.auth')
...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {{ Form::open(['url' => route('frontarea.auth.login.process'), 'id' => 'frontarea-auth-login-process']) }}
            ...
            {{ Html::link(route('frontarea.passwordreset.request'), trans('cortex/fort::common.forgot_password')) }}<br />
            {{ Html::link(route('frontarea.auth.register'), trans('cortex/fort::common.register')) }}
