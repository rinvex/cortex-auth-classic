...
@section('content')
    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            {{ Form::open(['url' => route('frontarea.auth.register.process'), 'id' => 'frontarea-auth-register-process']) }}
                ...
                <div class="row">
                    <div class="col-xs-8">
                        {{ Html::link(route('frontarea.auth.login'), trans('cortex/fort::common.registered_already')) }}
