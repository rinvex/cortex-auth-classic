...
{{-- Scripts --}}
@push('scripts')
    {!! JsValidator::formRequest(Cortex\Fort\Http\Requests\Frontarea\PasswordResetPostProcessRequest::class)->selector('#frontarea-passwordreset-process') !!}
@endpush
...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {{ Form::open(['url' => route('frontarea.passwordreset.process'), 'id' => 'frontarea-passwordreset-process']) }}
