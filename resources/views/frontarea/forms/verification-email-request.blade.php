...
{{-- Scripts --}}
@push('scripts')
    {!! JsValidator::formRequest(Cortex\Fort\Http\Requests\Frontarea\EmailVerificationProcessRequest::class)->selector('#frontarea-verification-email-send') !!}
@endpush
...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {{ Form::open(['url' => route('frontarea.verification.email.send'), 'id' => 'frontarea-verification-email-send']) }}
