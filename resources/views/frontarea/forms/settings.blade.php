                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="basic-tab">
                                ...
                                {{ Form::model($currentUser, ['url' => route('frontarea.account.settings.update'), 'class' => 'form-horizontal', 'id' => 'frontarea-account-settings-update']) }}
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="collapse col-md-10 col-md-offset-1" id="collapseTwoFactor">
                                                            ...
                                                            <div class="panel panel-primary">
                                                                <header class="panel-heading">
                                                                    @if(! empty($twoFactor['totp']['enabled']))
                                                                        <a class="btn btn-default btn-flat btn-xs pull-right" href="{{ route('frontarea.account.twofactor.totp.disable') }}" onclick="event.preventDefault(); var form = document.getElementById('frontarea-account-settings-update'); form.action = '{{ route('frontarea.account.twofactor.totp.disable') }}'; form.submit();">{{ trans('cortex/fort::common.disable') }}</a>
                                                        ...
                                                        @if(in_array('phone', config('rinvex.fort.twofactor.providers')))
                                                            ...
                                                            <div class="panel panel-primary">
                                                                <header class="panel-heading">
                                                                    <a class="btn btn-default btn-flat btn-xs pull-right" href="{{ route('frontarea.account.twofactor.phone.'.(! empty($twoFactor['phone']['enabled']) ? 'disable' : 'enable')) }}" onclick="event.preventDefault(); var form = document.getElementById('frontarea-account-settings-update'); form.action = '{{ route('frontarea.account.twofactor.phone.'.(! empty($twoFactor['phone']['enabled']) ? 'disable' : 'enable')) }}'; form.submit();">{{ trans('cortex/fort::common.'.(! empty($twoFactor['phone']['enabled']) ? 'disable' : 'enable')) }}</a>
