...
{{-- Scripts --}}
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Tenantarea\RegistrationProcessRequest::class)->selector('#tenantarea-registration-form')->ignore('.skip-validation') !!}
@endpush
