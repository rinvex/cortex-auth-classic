                ...
                <div class="profile-content">
                    ...
                    {{ Form::model($currentUser, ['url' => route('tenantarea.account.password.update'), 'id' => 'tenantarea-account-password-form']) }}
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="password-tab">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    {{ Form::button('<i class="fa fa-user"></i> '.trans('cortex/fort::common.update_password'), ['class' => 'btn btn-primary btn-flat', 'type' => 'submit']) }}
                                </div>
                            </div>
