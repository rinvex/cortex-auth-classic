...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Tenantarea\AccountSettingsRequest::class)->selector('#tenantarea-cortex-auth-account-settings-form')->ignore('.skip-validation') !!}
        ...
        <div class="row profile">
            ...
            <div class="col-md-9">
                <div class="profile-content">
                    ...
                    {{ Form::model(request()->user(), ['url' => route('tenantarea.cortex.auth.account.settings.update'), 'id' => 'tenantarea-cortex-auth-account-settings-form', 'files' => true]) }}
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    @elseif(request()->user()->email)
                                        <small class="text-danger">{!! trans('cortex/auth::common.email_unverified', ['href' => route('tenantarea.cortex.auth.account.verification.email.request')]) !!}</small>
                                    @endif
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group has-feedback{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    @elseif(request()->user()->phone)
                                        <small class="text-danger">{!! trans('cortex/auth::common.phone_unverified', ['href' => route('tenantarea.cortex.auth.account.verification.phone.request')]) !!}</small>
                                    @endif
                                ...
                                <div class="form-group has-feedback{{ $errors->has('profile_picture') ? ' has-error' : '' }}">
                                    ...
                                    @if (request()->user()->exists && request()->user()->getMedia('profile_picture')->count())
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#delete-confirmation"
                                           data-modal-action="{{ route('tenantarea.cortex.auth.account.media.destroy', ['member' => request()->user(), 'media' => request()->user()->getFirstMedia('profile_picture')]) }}"
                                           ...
                                           data-modal-body="{{ trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/foundation::common.media'), 'identifier' => request()->user()->getFirstMedia('profile_picture')->file_name]) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group has-feedback{{ $errors->has('cover_photo') ? ' has-error' : '' }}">
                                    ...
                                    @if (request()->user()->exists && request()->user()->getMedia('cover_photo')->count())
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#delete-confirmation"
                                           data-modal-action="{{ route('tenantarea.cortex.auth.account.media.destroy', ['member' => request()->user(), 'media' => request()->user()->getFirstMedia('cover_photo')]) }}"
                                           data-modal-title="{{ trans('cortex/foundation::messages.delete_confirmation_title') }}"
                                           data-modal-button="<a href='#' class='btn btn-danger' data-form='delete' data-token='{{ csrf_token() }}'><i class='fa fa-trash-o'></i> {{ trans('cortex/foundation::common.delete') }}</a>"
                                           data-modal-body="{{ trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/foundation::common.media'), 'identifier' => request()->user()->getFirstMedia('cover_photo')->file_name]) }}"
                                           title="{{ trans('cortex/foundation::common.delete') }}"><i class="fa fa-trash text-danger"></i></a>
                                    @endif
