            ...
            <div class="col-md-3">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-usermenu">
                        <ul class="nav">
                            <li class="active"><a href="{{ route('frontarea.account.settings') }}#settings-tab" aria-controls="settings-tab" role="tab" data-toggle="tab"><i class="fa fa-cogs"></i>{{ trans('cortex/fort::common.settings') }}</a></li>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            @elseif($currentUser->email)
                                                <small class="text-danger">{!! trans('cortex/fort::common.email_unverified', ['href' => route('tenantarea.verification.email.request')]) !!}</small>
                                            @endif
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group has-feedback{{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            @elseif($currentUser->phone)
                                                <small class="text-danger">{!! trans('cortex/fort::common.phone_unverified', ['href' => route('tenantarea.verification.phone.request')]) !!}</small>
                                            @endif
