    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                @includeWhen($role->exists, 'cortex/foundation::common.partials.actions', ['name' => 'role', 'model' => $role, 'resource' => trans('cortex/auth::common.role'), 'routePrefix' => 'managerarea.cortex.auth.roles.'])
                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @include('cortex/foundation::common.partials.timestamps', ['model' => $role])
