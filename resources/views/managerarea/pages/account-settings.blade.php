...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Managerarea\AccountSettingsRequest::class)->selector('#managerarea-cortex-auth-account-settings-form')->ignore('.skip-validation') !!}
