...
@section('tabs')
    ...
    @if(method_exists($resource, 'causedActivity')) <li><a href="{{ route("managerarea.{$type}.activities", [str_singular($type) => $resource]) }}">{{ trans('cortex/foundation::common.activities') }}</a></li> @endif
@stop
