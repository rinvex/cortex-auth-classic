    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                @includeWhen($member->exists, 'cortex/foundation::common.partials.actions', ['name' => 'member', 'model' => $member, 'resource' => trans('cortex/auth::common.member'), 'routePrefix' => 'managerarea.cortex.auth.members.'])
                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @include('cortex/foundation::common.partials.timestamps', ['model' => $member])
