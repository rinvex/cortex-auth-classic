...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Managerarea\AccountTwoFactorTotpProcessRequest::class)->selector('#managerarea-twofactor-totp-form')->ignore('.skip-validation') !!}
@endpush
