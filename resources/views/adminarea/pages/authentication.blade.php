...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            {{ Form::open(['url' => route('adminarea.cortex.auth.account.login.process'), 'id' => 'adminarea-cortex-auth-login-form', 'role' => 'auth']) }}
            ...
            {{ Html::link(route('adminarea.cortex.auth.account.passwordreset.request'), trans('cortex/auth::common.passwordreset')) }}
