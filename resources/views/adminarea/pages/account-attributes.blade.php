...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Adminarea\AccountAttributesRequest::class)->selector('#adminarea-cortex-auth-account-attributes-form')->ignore('.skip-validation') !!}
@endpush
