...
@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Auth\Http\Requests\Adminarea\MemberFormRequest::class)->selector("#adminarea-members-create-form, #adminarea-members-{$member->getKey()}-update-form") !!}
