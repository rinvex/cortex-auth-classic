...
{{-- Page Title --}}
@section('title')
    {{ config('app.name') }} » {{ trans('cortex/fort::common.account_settings') }}
@endsection

@push('inline-scripts')
    {!! JsValidator::formRequest(Cortex\Fort\Http\Requests\Adminarea\AccountSettingsRequest::class)->selector('#adminarea-account-settings-form') !!}
                        ...
                        {{ Form::model($currentUser, ['url' => route('adminarea.account.settings.update'), 'id' => 'adminarea-account-settings-form']) }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        @elseif($currentUser->email)
                                            <small class="text-danger">{!! trans('cortex/fort::common.email_unverified', ['href' => route('adminarea.verification.email.request')]) !!}</small>
                                        @endif
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group has-feedback{{ $errors->has('phone') ? ' has-error' : '' }}">
                                        ...
                                        @elseif($currentUser->phone)
                                            <small class="text-danger">{!! trans('cortex/fort::common.phone_unverified', ['href' => route('adminarea.verification.phone.request')]) !!}</small>
                                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center profile-buttons">
                                    {{ Form::button('<i class="fa fa-save"></i> '.trans('cortex/fort::common.update_settings'), ['class' => 'btn btn-primary btn-flat', 'type' => 'submit']) }}
                                </div>
                            </div>
