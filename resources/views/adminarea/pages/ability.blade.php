                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group{{ $errors->has('entity_type') ? ' has-error' : '' }}">
                                        ...
                                        {{ Form::select('entity_type', $entityTypes, null, ['class' => 'form-control select2', 'placeholder' => trans('cortex/auth::common.select_entity_type'), 'data-tags' => 'true', 'data-width' => '100%']) }}
