            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li>
                                <a href="{{ route('frontend.auth.login') }}"> {{ trans('cortex/fort::common.login') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('frontend.auth.register') }}"> {{ trans('cortex/fort::common.register') }}</a>
                            </li>
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li class="disabled"><a href="#"><i class="fa fa-user"></i> {{ trans('cortex/fort::common.account') }}</a></li>
