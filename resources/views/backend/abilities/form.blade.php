...
{{-- Page Title --}}
@section('title')
    {{ config('app.name') }} » {{ trans('cortex/fort::common.abilities') }} » {{ trans('cortex/fort::common.'.$mode) }} @if($ability->exists) {{ $ability->slug }} @endif
@stop
        ...
        @endif
            ...
            <section class="panel panel-default">
                ...
                <header class="panel-heading">
                    <h4>
                        <a href="{{ route('backend.abilities.index') }}">{{ trans('cortex/fort::common.abilities') }}</a> » {{ trans('cortex/fort::common.'.$mode) }} @if($ability->exists) <strong>{{ $ability->slug }}</strong> @endif
                        @if($ability->exists)
