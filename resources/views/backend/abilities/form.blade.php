...
{{-- Page Title --}}
@section('title')
    {{ config('app.name') }} » {{ trans('cortex/fort::common.abilities.label') }} » {{ $ability->exists ? $ability->slug : trans('cortex/fort::common.abilities.create') }}
@stop
        ...
        @endif
            ...
            <section class="panel panel-default">
                ...
                <header class="panel-heading">
                    <h4>
                        <a href="{{ route('backend.abilities.index') }}">{{ trans('cortex/fort::common.abilities.label') }}</a> » {{ $ability->exists ? $ability->slug : trans('cortex/fort::common.abilities.create') }}
                        @if($ability->exists)
