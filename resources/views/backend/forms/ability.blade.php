                                ...
                                @can('grant-abilities')
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                                            ...
                                            {{ Form::select('role[]', $roles, null, ['class' => 'form-control select2', 'placeholder' => trans('cortex/fort::common.select_roles'), 'multiple' => 'multiple', 'data-close-on-select' => 'false', 'data-width' => '100%']) }}
