...
{{-- Page Title --}}
@section('title')
    {{ config('app.name') }} » {{ trans('cortex/fort::common.dashboard') }}
@stop
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="jumbotron">
                    <h1><i class="fa fa-dashboard"></i> {{ trans('cortex/fort::common.dashboard') }}</h1>

                    <div class="row">
                        <div class="col-md-8">
                            <section class="panel panel-default">
                                <header class="panel-heading">
                                    <a class="btn btn-xs btn-default" href="{{ route('backend.users.index') }}" role="button">{{ trans('cortex/fort::common.recent_registered') }}</a>
                                </header>
                                        ...
                                        <table class="table table-hover" style="margin-bottom: 0">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%">{{ trans('cortex/fort::common.status') }}</th>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <section class="panel panel-default">
                                    <header class="panel-heading">
                                        <strong>{{ trans('cortex/fort::common.statistics') }}</strong>
                                    </header>
