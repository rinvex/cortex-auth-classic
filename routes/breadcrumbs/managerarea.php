...
Breadcrumbs::register('managerarea.cortex.auth.roles.index', function (BreadcrumbsGenerator $breadcrumbs) {
...
Breadcrumbs::register('managerarea.cortex.auth.roles.import', function (BreadcrumbsGenerator $breadcrumbs) {
...
Breadcrumbs::register('managerarea.cortex.auth.roles.import.logs', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.auth.roles.index');
    $breadcrumbs->push(trans('cortex/auth::common.import'), route('managerarea.cortex.auth.roles.import'));
    $breadcrumbs->push(trans('cortex/auth::common.logs'), route('managerarea.cortex.auth.roles.import.logs'));
});

Breadcrumbs::register('managerarea.cortex.auth.roles.create', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.auth.roles.index');
    $breadcrumbs->push(trans('cortex/auth::common.create_role'), route('managerarea.cortex.auth.roles.create'));
});

Breadcrumbs::register('managerarea.cortex.auth.roles.edit', function (BreadcrumbsGenerator $breadcrumbs, Role $role) {
    $breadcrumbs->parent('managerarea.cortex.auth.roles.index');
    $breadcrumbs->push(strip_tags($role->title), route('managerarea.cortex.auth.roles.edit', ['role' => $role]));
});

Breadcrumbs::register('managerarea.cortex.auth.roles.logs', function (BreadcrumbsGenerator $breadcrumbs, Role $role) {
    $breadcrumbs->parent('managerarea.cortex.auth.roles.index');
    $breadcrumbs->push(strip_tags($role->title), route('managerarea.cortex.auth.roles.edit', ['role' => $role]));
    $breadcrumbs->push(trans('cortex/auth::common.logs'), route('managerarea.cortex.auth.roles.logs', ['role' => $role]));
});

Breadcrumbs::register('managerarea.cortex.auth.members.index', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.app('request.tenant')->name, route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.members'), route('managerarea.cortex.auth.members.index'));
});

Breadcrumbs::register('managerarea.cortex.auth.members.import', function (BreadcrumbsGenerator $breadcrumbs) {
...
Breadcrumbs::register('managerarea.cortex.auth.members.import.logs', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.auth.members.index');
    $breadcrumbs->push(trans('cortex/auth::common.import'), route('managerarea.cortex.auth.members.import'));
    $breadcrumbs->push(trans('cortex/auth::common.logs'), route('managerarea.cortex.auth.members.import.logs'));
});

Breadcrumbs::register('managerarea.cortex.auth.members.create', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.auth.members.index');
    $breadcrumbs->push(trans('cortex/auth::common.create_member'), route('managerarea.cortex.auth.members.create'));
});

Breadcrumbs::register('managerarea.cortex.auth.members.edit', function (BreadcrumbsGenerator $breadcrumbs, Member $member) {
    $breadcrumbs->parent('managerarea.cortex.auth.members.index');
    $breadcrumbs->push(strip_tags($member->username), route('managerarea.cortex.auth.members.edit', ['member' => $member]));
});

Breadcrumbs::register('managerarea.cortex.auth.members.logs', function (BreadcrumbsGenerator $breadcrumbs, Member $member) {
    $breadcrumbs->parent('managerarea.cortex.auth.members.index');
    $breadcrumbs->push(strip_tags($member->username), route('managerarea.cortex.auth.members.edit', ['member' => $member]));
    $breadcrumbs->push(trans('cortex/auth::common.logs'), route('managerarea.cortex.auth.members.logs', ['member' => $member]));
});

Breadcrumbs::register('managerarea.cortex.auth.members.activities', function (BreadcrumbsGenerator $breadcrumbs, Member $member) {
    $breadcrumbs->parent('managerarea.cortex.auth.members.index');
    $breadcrumbs->push(strip_tags($member->username), route('managerarea.cortex.auth.members.edit', ['member' => $member]));
    $breadcrumbs->push(trans('cortex/auth::common.activities'), route('managerarea.cortex.auth.members.activities', ['member' => $member]));
});

Breadcrumbs::register('managerarea.cortex.auth.members.attributes', function (BreadcrumbsGenerator $breadcrumbs, Member $member) {
    $breadcrumbs->parent('managerarea.cortex.auth.members.index');
    $breadcrumbs->push(strip_tags($member->username), route('managerarea.cortex.auth.members.edit', ['member' => $member]));
    $breadcrumbs->push(trans('cortex/auth::common.attributes'), route('managerarea.cortex.auth.members.attributes', ['member' => $member]));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.index', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.app('request.tenant')->name, route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.managers'), route('managerarea.cortex.auth.managers.index'));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.import', function (BreadcrumbsGenerator $breadcrumbs) {
...
Breadcrumbs::register('managerarea.cortex.auth.managers.import.logs', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.auth.managers.index');
    $breadcrumbs->push(trans('cortex/auth::common.import'), route('managerarea.cortex.auth.managers.import'));
    $breadcrumbs->push(trans('cortex/auth::common.logs'), route('managerarea.cortex.auth.managers.import.logs'));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.create', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.auth.managers.index');
    $breadcrumbs->push(trans('cortex/auth::common.create_manager'), route('managerarea.cortex.auth.managers.create'));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.edit', function (BreadcrumbsGenerator $breadcrumbs, Manager $manager) {
    $breadcrumbs->parent('managerarea.cortex.auth.managers.index');
    $breadcrumbs->push(strip_tags($manager->username), route('managerarea.cortex.auth.managers.edit', ['manager' => $manager]));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.logs', function (BreadcrumbsGenerator $breadcrumbs, Manager $manager) {
    $breadcrumbs->parent('managerarea.cortex.auth.managers.index');
    $breadcrumbs->push(strip_tags($manager->username), route('managerarea.cortex.auth.managers.edit', ['manager' => $manager]));
    $breadcrumbs->push(trans('cortex/auth::common.logs'), route('managerarea.cortex.auth.managers.logs', ['manager' => $manager]));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.activities', function (BreadcrumbsGenerator $breadcrumbs, Manager $manager) {
    $breadcrumbs->parent('managerarea.cortex.auth.managers.index');
    $breadcrumbs->push(strip_tags($manager->username), route('managerarea.cortex.auth.managers.edit', ['manager' => $manager]));
    $breadcrumbs->push(trans('cortex/auth::common.activities'), route('managerarea.cortex.auth.managers.activities', ['manager' => $manager]));
});

Breadcrumbs::register('managerarea.cortex.auth.managers.attributes', function (BreadcrumbsGenerator $breadcrumbs, Manager $manager) {
    $breadcrumbs->parent('managerarea.cortex.auth.managers.index');
    $breadcrumbs->push(strip_tags($manager->username), route('managerarea.cortex.auth.managers.edit', ['manager' => $manager]));
...
// Account Breadcrumbs
Breadcrumbs::register('managerarea.cortex.auth.account.login', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.login'), route('managerarea.cortex.auth.account.login'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.passwordreset.request', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
...
Breadcrumbs::register('managerarea.cortex.auth.account.passwordreset.reset', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.passwordreset'), route('managerarea.cortex.auth.account.passwordreset.reset'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.reauthentication.password', function (BreadcrumbsGenerator $breadcrumbs) {
...
Breadcrumbs::register('managerarea.cortex.auth.account.reauthentication.twofactor', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-home"></i> '.config('app.name'), route('frontarea.home'));
...
Breadcrumbs::register('managerarea.cortex.auth.account.verification.email.request', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
...
Breadcrumbs::register('managerarea.cortex.auth.account.verification.phone.request', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
...
Breadcrumbs::register('managerarea.cortex.auth.account.verification.phone.verify', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.verify_phone'), route('managerarea.cortex.auth.account.verification.phone.verify'));
});

Breadcrumbs::register('managerarea.cortex.auth.account', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.account'), route('managerarea.cortex.auth.account'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.settings', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.account_settings'), route('managerarea.cortex.auth.account.settings'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.password', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.account_password'), route('managerarea.cortex.auth.account.password'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.attributes', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.account_attributes'), route('managerarea.cortex.auth.account.attributes'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.sessions', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.account_sessions'), route('managerarea.cortex.auth.account.sessions'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.twofactor', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
    $breadcrumbs->push(trans('cortex/auth::common.account_twofactor'), route('managerarea.cortex.auth.account.twofactor'));
});

Breadcrumbs::register('managerarea.cortex.auth.account.twofactor.totp.enable', function (BreadcrumbsGenerator $breadcrumbs) {
    $breadcrumbs->push('<i class="fa fa-dashboard"></i> '.config('app.name'), route('managerarea.home'));
