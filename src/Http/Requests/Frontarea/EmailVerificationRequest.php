...
class EmailVerificationRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        if ($userVerified || $guestVerified) {
            ...
            throw new GenericException(trans('cortex/fort::messages.verification.email.already_verified'), $userVerified ? route('frontarea.account.settings') : route('frontarea.login'));
        }
