...
use Cortex\Fort\Http\Requests\Memberarea\TwoFactorTotpSettingsRequest;
use Cortex\Fort\Http\Requests\Memberarea\TwoFactorPhoneSettingsRequest;
use Cortex\Fort\Http\Requests\Memberarea\TwoFactorTotpBackupSettingsRequest;
use Cortex\Fort\Http\Requests\Memberarea\TwoFactorTotpProcessSettingsRequest;
...
class TwoFactorSettingsController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Fort\Http\Requests\Memberarea\TwoFactorTotpSettingsRequest $request
    ...
    public function enableTotp(TwoFactorTotpSettingsRequest $request, Google2FA $totpProvider)
    {
        ...
        return view('cortex/fort::memberarea.forms.twofactor', compact('secret', 'qrCode', 'twoFactor'));
    }
     ...
     *
     * @param \Cortex\Fort\Http\Requests\Memberarea\TwoFactorTotpProcessSettingsRequest $request
     * @param \PragmaRX\Google2FA\Google2FA                                             $totpProvider
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Fort\Http\Requests\Memberarea\TwoFactorTotpBackupSettingsRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Fort\Http\Requests\Memberarea\TwoFactorPhoneSettingsRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
