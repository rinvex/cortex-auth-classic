...
class AdminsController extends AuthorizedController
{
    ...
    protected function process(FormRequest $request, Admin $admin)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/auth::common.admin'), 'identifier' => strip_tags($admin->username)])],
        ]);
    }
    ...
    public function destroy(Admin $admin)
    {
        ...
        return intend([
            'url' => route('adminarea.admins.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/auth::common.admin'), 'identifier' => strip_tags($admin->username)])],
        ]);
    }
}
