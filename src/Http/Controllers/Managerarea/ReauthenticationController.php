...
use Cortex\Auth\Http\Requests\Managerarea\ReauthenticatePasswordFormRequest;
...
class ReauthenticationController extends AuthenticatedController
{
    ...
    {
        return view('cortex/auth::managerarea.pages.reauthentication-password');
    }

    /**
     * Process password.
     *
     * @param \Cortex\Auth\Http\Requests\Managerarea\ReauthenticatePasswordFormRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function processPassword(ReauthenticatePasswordFormRequest $request)
    {
        ...
        return intend([
            'intended' => url(route('managerarea.home')),
        ]);
    }
