...
class RolesController extends AuthorizedController
{
    ...
    public function logs(Role $role, LogsDataTable $logsDataTable)
    {
        return $logsDataTable->with([
            ...
            'id' => "managerarea-roles-{$role->getRouteKey()}-logs",
    ...
    public function import(Role $role, ImportRecordsDataTable $importRecordsDataTable)
    {
        return $importRecordsDataTable->with([
            ...
            'id' => "managerarea-roles-{$role->getRouteKey()}-import",
    ...
    public function importLogs(ImportLogsDataTable $importLogsDatatable)
    {
        return $importLogsDatatable->with([
            ...
            'tabs' => 'managerarea.roles.tabs',
            'id' => 'managerarea-roles-import-logs',
        ])->render('cortex/foundation::managerarea.pages.datatable-tab');
    }
    ...
    protected function process(FormRequest $request, Role $role)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/auth::common.role'), 'identifier' => strip_tags($role->title)])],
        ]);
    }
    ...
    public function destroy(Role $role)
    {
        ...
        return intend([
            'url' => route('managerarea.roles.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/auth::common.role'), 'identifier' => strip_tags($role->title)])],
        ]);
    }
}
