...
class ManagersController extends AuthorizedController
{
    ...
    public function logs(Manager $manager, LogsDataTable $logsDataTable)
    {
        return $logsDataTable->with([
            ...
            'id' => "managerarea-managers-{$manager->getRouteKey()}-logs",
    ...
    public function activities(Manager $manager, ActivitiesDataTable $activitiesDataTable)
    {
        return $activitiesDataTable->with([
            'resource' => $manager,
            'tabs' => 'managerarea.managers.tabs',
            'id' => "managerarea-managers-{$manager->getRouteKey()}-activities",
        ])->render('cortex/foundation::managerarea.pages.datatable-tab');
    }
    ...
    public function import(Manager $manager, ImportRecordsDataTable $importRecordsDataTable)
    {
        return $importRecordsDataTable->with([
            ...
            'id' => "managerarea-attributes-{$manager->getRouteKey()}-import",
    ...
    public function importLogs(ImportLogsDataTable $importLogsDatatable)
    {
        return $importLogsDatatable->with([
            ...
            'tabs' => 'managerarea.managers.tabs',
            'id' => 'managerarea-managers-import-logs',
        ])->render('cortex/foundation::managerarea.pages.datatable-tab');
    }
    ...
    protected function process(FormRequest $request, Manager $manager)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/auth::common.manager'), 'identifier' => strip_tags($manager->username)])],
        ]);
    }
    ...
    public function destroy(Manager $manager)
    {
        ...
        return intend([
            'url' => route('managerarea.managers.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/auth::common.manager'), 'identifier' => strip_tags($manager->username)])],
        ]);
    }
}
