...
use Cortex\Fort\Http\Requests\Guestarea\AuthenticationRequest;
...
class AuthenticationController extends AbstractController
{
    ...
    public function form()
    {
        ...
        return view('cortex/fort::guestarea.forms.auth-login');
    }

    /**
     * Process to the login form.
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\AuthenticationRequest $request
     *
