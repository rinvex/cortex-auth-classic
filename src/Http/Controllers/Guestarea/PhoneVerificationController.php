...
use Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationRequest;
use Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationSendRequest;
use Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationProcessRequest;
use Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationSendProcessRequest;
...
class PhoneVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationSendRequest $request
     *
     * @return \Illuminate\Http\Response|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function request(PhoneVerificationSendRequest $request)
    {
        return view('cortex/fort::guestarea.forms.verification-phone-request');
    }

    /**
     * Process the phone verification request form.
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationSendProcessRequest $request
     *
    ...
    public function send(PhoneVerificationSendProcessRequest $request)
    {
        ...
        return intend([
            'url' => route('guestarea.verification.phone.verify'),
     ...
     * Show the phone verification form.
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationRequest $request
     *
     * @return \Illuminate\Http\Response|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function verify(PhoneVerificationRequest $request)
    {
        ...
        return view('cortex/fort::guestarea.forms.verification-phone-token', compact('phoneEnabled'));
    }

    /**
     * Process the phone verification form.
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\PhoneVerificationProcessRequest $request
     *
     * @return \Illuminate\Http\Response|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function process(PhoneVerificationProcessRequest $request)
    {
        ...
        switch ($result) {
            case SessionGuard::AUTH_PHONE_VERIFIED:
                ...
                return intend([
                    'url' => route('memberarea.account.settings'),
