...
use Cortex\Fort\Http\Requests\Guestarea\RegistrationRequest;
use Cortex\Fort\Http\Requests\Guestarea\RegistrationProcessRequest;
...
class RegistrationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\RegistrationRequest $request
     *
     * @return \Illuminate\Http\Response|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
    public function form(RegistrationRequest $request)
    {
        return view('cortex/fort::guestarea.forms.auth-register');
    }

    /**
     * Process the registration form.
     *
     * @param \Cortex\Fort\Http\Requests\Guestarea\RegistrationProcessRequest $request
