...
use Cortex\Fort\Http\Requests\Tenantarea\AccountAttributesRequest;
...
class AccountAttributesController extends AuthenticatedController
{
    ...
    {
        return view('cortex/fort::tenantarea.pages.account-attributes');
    }

    /**
     * Process the account update form.
     *
     * @param \Cortex\Fort\Http\Requests\Tenantarea\AccountAttributesRequest $request
     *
