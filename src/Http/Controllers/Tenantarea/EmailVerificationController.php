...
use Cortex\Auth\Http\Requests\Tenantarea\EmailVerificationRequest;
use Cortex\Auth\Http\Requests\Tenantarea\EmailVerificationSendRequest;
use Cortex\Auth\Http\Requests\Tenantarea\EmailVerificationProcessRequest;
...
class EmailVerificationController extends AbstractController
{
     ...
     *
     * @param \Cortex\Auth\Http\Requests\Tenantarea\EmailVerificationRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\Http\Requests\Tenantarea\EmailVerificationSendRequest $request
     *
     ...
     *
     * @param \Cortex\Auth\Http\Requests\Tenantarea\EmailVerificationProcessRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
