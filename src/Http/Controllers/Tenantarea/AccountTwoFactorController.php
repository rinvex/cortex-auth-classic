...
class AccountTwoFactorController extends AuthenticatedController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cortex/fort::tenantarea.pages.account-twofactor', compact('twoFactor'));
    }
    ...
    public function enableTotp(Request $request, Google2FA $totpProvider)
    {
        ...
        return view('cortex/fort::tenantarea.pages.account-twofactor-totp', compact('secret', 'qrCode', 'twoFactor'));
    }
