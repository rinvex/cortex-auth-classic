...
use Cortex\Auth\Http\Requests\Frontarea\AccountTwoFactorPhoneRequest;
use Cortex\Auth\Http\Requests\Frontarea\AccountTwoFactorTotpBackupRequest;
use Cortex\Auth\Http\Requests\Frontarea\AccountTwoFactorTotpProcessRequest;
...
class AccountTwoFactorController extends AuthenticatedController
{
     ...
     *
     * @param \Cortex\Auth\Http\Requests\Frontarea\AccountTwoFactorTotpBackupRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
     ...
     *
     * @param \Cortex\Auth\Http\Requests\Frontarea\AccountTwoFactorPhoneRequest $request
     *
     * @return \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
     */
